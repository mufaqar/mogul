...
const rentals = [
  {
    image: "/images/seventh-west-card.jpg",
  ...
  return (
    <div className="bg-white rounded-lg shadow-md border border-gray-200 flex flex-col">
      ...
      <div className="flex  gap-2 px-4 pb-4 mt-auto">
        <Link
          href="/"
          className=" text-sm  py-1 rounded text-center flex gap-1 items-center"
        >
        ...
        <Link
          href="/"
          className="bg-black text-white text-sm px-3 py-1.5 font-semibold  w-full rounded hover:opacity-90 text-center"
        >
          Check availability
        </Link>
      </div>
